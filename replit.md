...
### Улучшения UI и функциональности
- ✅ Улучшен glassmorphism эффект с более матовым стеклом на карточках
- ✅ Добавлена иконка профиля в хедер главной страницы для залогиненных пользователей
- ✅ Логотип WIRALIS по центру для незалогиненных пользователей
- ✅ Обновлена карточка "Жду Сайт" с персонализированным текстом для зарегистрированных пользователей
- ✅ Информация о выходе публичной версии перемещена в футер

### Расширение профиля
- ✅ Добавлена поддержка бейджей (активный бейдж отображается рядом с никнеймом)
- ✅ Добавлена поддержка тем оформления
- ✅ Индикатор администратора для пользователей с telegramId 1971071274 и 7992966340
- ✅ Кнопка "Поднадчивания" в личном профиле для отправки сигнала боту
- ✅ Расширена схема БД: добавлены поля role, activeBadgeEmoji, activeBadgeName, activeThemeName
...
- ✅ Добавлен endpoint /api/nudge для интеграции с ботом
- ✅ telegramId теперь возвращается во всех API responses
...
- `active_badge_emoji` (text) - Emoji активного бейджа
- `active_badge_name` (text) - Название активного бейджа
- `active_theme_name` (text) - Название активной темы оформления
